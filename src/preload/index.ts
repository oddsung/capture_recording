...
const api: CaptureApi = {
  ...
  copyItemImage: (id: string) => ipcRenderer.invoke(IPC.COPY_ITEM_IMAGE, id),
  saveItemImage: (id: string) => ipcRenderer.invoke(IPC.SAVE_ITEM_IMAGE, id),
  chooseExportDir: () => ipcRenderer.invoke(IPC.CHOOSE_EXPORT_DIR),
  getExportDefaults: () => ipcRenderer.invoke(IPC.GET_EXPORT_DEFAULTS),
